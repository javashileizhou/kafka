...
object PartitionLeaderElectionAlgorithms {
  def offlinePartitionLeaderElection(assignment: Seq[Int], // 分区的副本列表
                                     isr: Seq[Int], // 分区所有与Leader副本保持同步的副本列表
                                     liveReplicas: Set[Int], // 分区下所有处于存活状态的副本
